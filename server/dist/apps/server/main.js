...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [common_2.CommonModule, auth_1.AuthModule.forRoot('server')],
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getSmsDto = exports.loginDto = exports.registerDto = void 0;
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
class registerDto {
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '图形验证码', example: '1234' }),
    __metadata("design:type", String)
], registerDto.prototype, "captcha", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '手机号', example: '18711003418' }),
    __metadata("design:type", String)
...
exports.getSmsDto = getSmsDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: '手机号', example: '18711003418' }),
    __metadata("design:type", String)
], getSmsDto.prototype, "mobile", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '图形验证码', example: '1234' }),
    __metadata("design:type", String)
], getSmsDto.prototype, "captcha", void 0);
...
__decorate([
    (0, common_1.Post)('sms'),
    (0, swagger_1.ApiOperation)({ summary: '获取短信验证码' }),
    (0, common_1.UseGuards)(common_2.CaptchaGuard),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __param(2, (0, common_1.Session)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof auth_dto_1.getSmsDto !== "undefined" && auth_dto_1.getSmsDto) === "function" ? _f : Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CommonAuthController.prototype, "sms", null);
...
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
const jwt_1 = __webpack_require__(/*! @nestjs/jwt */ "@nestjs/jwt");
const captcha_guard_1 = __webpack_require__(/*! common/common/guards/captcha.guard */ "./libs/common/src/guards/captcha.guard.ts");
let ServerAuthController = exports.ServerAuthController = class ServerAuthController {
    ...
    async register(registerDto, session) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_e = typeof auth_dto_1.registerDto !== "undefined" && auth_dto_1.registerDto) === "function" ? _e : Object, Object]),
    __metadata("design:returntype", Promise)
], ServerAuthController.prototype, "register", null);
__decorate([
    (0, common_1.Post)('login'),
    (0, swagger_1.ApiOperation)({ summary: '用户登录' }),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('local-login'), captcha_guard_1.CaptchaGuard),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __param(2, (0, common_1.Session)()),
    __metadata("design:type", Function),
...
const tencentcloud = __webpack_require__(/*! tencentcloud-sdk-nodejs */ "tencentcloud-sdk-nodejs");
