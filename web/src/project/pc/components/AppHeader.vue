<template>
  <header id="app-header" class="h-14 fixed inset-x-0 top-0 px-12 flex items-center z-10 bg-white dark:bg-gray-950 drop-shadow-light dark:drop-shadow-dark" :class="{'header-hide': y > 200}">
