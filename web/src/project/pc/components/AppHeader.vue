<template>
  <header id="app-header" class="fixed inset-x-0 top-0 px-12 z-10 bg-white dark:bg-gray-950 drop-shadow-light dark:drop-shadow-dark" :class="{ 'header-hide': y > 200 }">
    <div class="h-14 flex items-center mx-auto" style="max-width: 1300px">
      ...
      <n-space class="right-icons flex-1" justify="end" align="center">
        ...
        <div>
          <a target="_blank" href="https://github.com/fangchenjia">
            <svg viewBox="0 0 24 24" width="1.5em" height="1.5em">
              ...
              <rect width="8" height="4" x="8" y="11" fill="currentColor" mask="url(#uicons-cx5pae91i8)">
        ...
        <n-tooltip placement="bottom" trigger="hover">
          <template #trigger>
            <i @click="appStore.toggleTheme()">
              <svg v-show="appStore.theme === 'dark'" viewBox="0 0 24 24" width="1.5em" height="1.5em">
                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                  <g stroke-dasharray="2">
                    <path d="M12 21v1M21 12h1M12 3v-1M3 12h-1"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.2s" values="4;2"></animate></path>
                ...
                <g fill="none" stroke="currentColor" stroke-dasharray="4" stroke-dashoffset="4" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M13 4h1.5M13 4h-1.5M13 4v1.5M13 4v-1.5">
                    ...
                    <animate
                      ...
                      values="0;4"
                    ></animate>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition0.begin+1.8s" to="M12 5h1.5M12 5h-1.5M12 5v1.5M12 5v-1.5"></set>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition0.begin+3.8s" to="M12 4h1.5M12 4h-1.5M12 4v1.5M12 4v-1.5"></set>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition0.begin+5.8s" to="M13 4h1.5M13 4h-1.5M13 4v1.5M13 4v-1.5"></set>
                  </path>
                  <path d="M19 11h1.5M19 11h-1.5M19 11v1.5M19 11v-1.5">
                    ...
                    <animate
                      ...
                      values="0;4"
                    ></animate>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition1.begin+1.8s" to="M17 11h1.5M17 11h-1.5M17 11v1.5M17 11v-1.5"></set>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition1.begin+3.8s" to="M18 12h1.5M18 12h-1.5M18 12v1.5M18 12v-1.5"></set>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition1.begin+5.8s" to="M19 11h1.5M19 11h-1.5M19 11v1.5M19 11v-1.5"></set>
                  </path>
                  <path d="M19 4h1.5M19 4h-1.5M19 4v1.5M19 4v-1.5">
                    <animate
                      ...
                      values="4;0"
                    ></animate>
                    <animate fill="freeze" attributeName="stroke-dashoffset" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition2.begin+2s" dur="0.4s" values="4;0"></animate>
                    <animate
                      fill="freeze"
                      attributeName="stroke-dashoffset"
                      ...
                      values="0;4"
                    ></animate>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition2.begin+1.8s" to="M20 5h1.5M20 5h-1.5M20 5v1.5M20 5v-1.5"></set>
                    <set attributeName="d" begin="lineMdSunnyFilledLoopToMoonAltFilledLoopTransition2.begin+5.8s" to="M19 4h1.5M19 4h-1.5M19 4v1.5M19 4v-1.5"></set>
                  </path>
                </g>
                <mask id="uicons-j4bqebqdbo">
                ...
                <circle cx="12" cy="12" r="6" fill="currentColor" mask="url(#uicons-j4bqebqdbo)">
                  <set attributeName="opacity" begin="0.5s" to="0"></set>
                  <animate fill="freeze" attributeName="r" begin="0.1s" dur="0.4s" values="6;10"></animate>
                </circle>
              </svg>
              <svg v-show="appStore.theme === 'light'" viewBox="0 0 24 24" width="1.5em" height="1.5em">
                ...
                <mask id="uicons-8i9dgwe5k6">
                  <circle cx="12" cy="12" r="12" fill="#fff"></circle>
                  <circle cx="12" cy="12" r="8"><animate fill="freeze" attributeName="r" dur="0.4s" values="8;4"></animate></circle>
                ...
                <circle cx="12" cy="12" r="10" fill="currentColor" mask="url(#uicons-8i9dgwe5k6)">
        ...
        <n-dropdown v-if="userStore.isLogin" :options="messageOptions" trigger="hover" @select="messageSelectHandle">
          <n-icon size="21" :component="Bell"> </n-icon>
        </n-dropdown>
        ...
        <div class="flex items-center">
          ...
          <!-- 登录按钮 -->
          <n-button v-else text type="primary" @click="LoginModal.open()"> 登录 </n-button>
        </div>
      </n-space>
    </div>
  </header>
