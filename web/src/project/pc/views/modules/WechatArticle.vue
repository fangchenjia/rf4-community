<template>
  <n-thing>
    <template #header>
      <span class="flex items-center">公众号专区<n-icon :size="20" :component="ArrowForwardIosRound"></n-icon></span
    ></template>
    <n-thing v-for="account in wechatAccountList" :key="account.__biz" class="mb-4">
      <!-- 公众号头像 -->
      <template #avatar>
...
// 公众号列表
const wechatAccountList: any = ref(
